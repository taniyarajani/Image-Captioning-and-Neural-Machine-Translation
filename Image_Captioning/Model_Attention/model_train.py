# Loading utilities and packages
import argparse
import torch
...
def main(args):
    ...
    # Create model directory to save trained model files
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_path', type=str, default='../flickr8k/Flickr_Data/Flickr_Data/Flickr_TextData/Flickr_8k.trainImages.txt', help='path for train split file')
