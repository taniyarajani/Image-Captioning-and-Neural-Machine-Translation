...
def main(args):
    ...
    for i, (images, captions) in enumerate(data_loader):
        ...
        if i in [0,1,2,3,4,5,6]:
            print(vocab.get_sentence(sampled_seq))
    ...
    print(corpus_bleu(ground_truth, predicted, weights=(1.0/4.0, 1.0/4.0, 1.0/4.0, 1.0/4.0)))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str, default='../flickr8k/Flickr_Data/Flickr_Data/Images/', help='directory for images')
    parser.add_argument('--caption_path', type=str, default='../flickr8k/Flickr_Data/Flickr_Data/Flickr_TextData/Flickr8k.token.txt', help='path for caption file')
    parser.add_argument('--val_path', type=str, default='../flickr8k/Flickr_Data/Flickr_Data/Flickr_TextData/Flickr_8k.testImages.txt', help='path for val split file')
